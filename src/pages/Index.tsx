...
import { UTISection } from "@/components/UTISection";
        ...
        <div className={printMode ? 'print-hide' : ''}>
          ...
          <main className="container mx-auto px-2 sm:px-4 py-3 sm:py-6 print:py-0 print:px-1">
            <div className="space-y-3 sm:space-y-4 print:space-y-1">
              {/* Renderização condicional: UTI vs Outras Emergências */}
              {currentDepartment === "UTI" ? (
                // Layout da UTI: seção única com todos os leitos
                <UTISection
                  patients={patients}
                  onUpdatePatient={handleUpdatePatient}
                  onDeletePatient={handleDeletePatient}
                  onAddBed={() => handleAddExtraBed("red")}
                  onPrintSection={() => handlePrintSector("red")}
                  selectionMode={selectionMode}
                  selectedPatients={selectedPatients}
                  onToggleSelection={handleToggleSelection}
                  onReorderPatients={(reordered) => {
                ...
                // Layout tradicional: setores separados (Cuidados Especiais, Amarela, Azul)
                <>
                  <div>
                    <SectorSection 
                      sector="red" 
