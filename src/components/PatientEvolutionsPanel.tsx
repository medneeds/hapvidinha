...
export function PatientEvolutionsPanel({ patientId, patientName }: PatientEvolutionsPanelProps) {
  ...
  const handlePrintSingle = (evo: Evolution) => {
...
<html><head><meta charset="utf-8"><title>Evolução - ${patientName}</title>
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .header {
    ...
    padding: 20px 36px 16px; display: flex; align-items: center; justify-content: center; position: relative;
  }
...
<div class="page">
  ...
  <div class="title-bar"><h1>Evolução Clínica</h1><span class="hospital-name">${whitelabel.institution.hospitalName}</span></div>
  <div class="patient-strip">
    <div class="field"><span class="field-label">Paciente</span><span class="field-value">${patientName}</span></div>
    <div class="divider"></div>
    <div class="field"><span class="field-label">Data</span><span class="field-value">${evoDate}</span></div>
    <div class="divider"></div>
    <div class="field"><span class="field-label">Hora</span><span class="field-value">${evoTime}</span></div>
    <div class="divider"></div>
    <div class="field"><span class="field-label">Autor</span><span class="field-value">${author}</span></div>
    <div class="divider"></div>
  ...
  <div class="body-content">
    ...
    <div class="body-text">${evo.content.replace(/\n/g, '<br/>')}</div>
  </div>
  <div class="footer">
    <div class="footer-accent"></div>
    <div class="footer-content">
      <div class="address">${whitelabel.institution.hospitalName}<br/>Urgência e Emergência — Evolução Clínica</div>
    ...
    Promise.all(imagePromises).then(() => { setTimeout(() => printWindow.print(), 300); });
  };
