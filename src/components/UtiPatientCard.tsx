...
export function UtiPatientCard({ 
  ...
  const colorSchemes = {
    ...
    yellow: {
      ...
      col1: "bg-amber-100/70 dark:bg-amber-900/35 border-amber-300/50 dark:border-amber-700/45",
      ...
      col3: "bg-amber-100/70 dark:bg-amber-900/35 border-amber-300/50 dark:border-amber-700/45",
      col3Icon: "text-amber-500 dark:text-amber-300",
      col4: "bg-amber-100/70 dark:bg-amber-900/35 border-amber-300/50 dark:border-amber-700/45",
