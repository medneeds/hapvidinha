          ...
          <div className="flex items-start justify-between gap-2 print:gap-1">
            ...
            {currentDepartment === "UTI" && (
              <>
                ...
                <div className="md:col-span-12 border-l-2 border-primary/20 pl-3 pr-0 py-2 bg-muted/5 rounded-r">
                ...
                <div className="md:col-span-12 border-l-2 border-muted-foreground/20 pl-3 pr-0 py-2 bg-muted/10 rounded-r">
                  <div className="grid grid-cols-12 gap-2">
                    {/* Motivo da Admissão */}
                    <div className="flex flex-col md:col-span-3">
                ...
                <div className="md:col-span-12 border-l-2 border-accent/30 pl-3 pr-0 py-2 bg-accent/5 rounded-r">
                  <div className="grid grid-cols-12 gap-2">
                    {/* Dispositivos */}
                    <div className="flex flex-col md:col-span-3">
