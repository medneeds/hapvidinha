            ...
            {currentDepartment === "UTI" && (
              <>
                ...
                <div className="md:col-span-18 border-l-2 border-muted-foreground/20 pl-3 pr-3 py-2 bg-muted/10 rounded-r">
                  <div className="grid grid-cols-18 gap-2 items-start">
                    {/* Motivo da Admissão */}
                  ...
                  <div className="flex flex-col md:col-span-7 relative min-w-0">
                  ...
                  {/* Especialidades */}
                  <div className="flex flex-col md:col-span-2 min-w-0">
                ...
                <div className="md:col-span-18 border-l-2 border-accent/30 pl-3 pr-3 py-2 bg-accent/5 rounded-r">
                  ...
                  {/* Exames */}
                  <div className="flex flex-col md:col-span-5 relative min-w-0">
                  <div className="flex items-center gap-1 mb-0.5">
